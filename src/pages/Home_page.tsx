        ...
        <div>
            ...
            <main className="container mx-auto px-4 py-8 bg-secondary min-h-screen min-w-screen">
                {Array.isArray(recipeList) ? (
                    <div>
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center pt-4">
                            Recipes
                        </h2>
                        {recipeList.length > 0 ? (
                                                    ...
                                                    {recipe.ingredients
                                                        ...
                                                        recipe.ingredients.map(
                                                            (
                                                                ...
                                                                <li
                                                                    key={idx}
                                                                    className="text-gray-600 list-disc list-inside text-sm"
                                                                >
                                                                    {ingredient}
                                                                </li>
                                                            )
                    ...
                    <div className="text-center py-8">
                        <p className="text-red-500">
                            Unexpected state: {JSON.stringify(recipeList)}
                        </p>
                    </div>
                )}
            </main>
